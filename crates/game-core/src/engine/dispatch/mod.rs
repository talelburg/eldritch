...
use crate::dsl::{Cost, SkillTestKind, Trigger};
use crate::event::Event;
use crate::state::{
    CardCode, CardInPlay, CardInstanceId, DefeatCause, Enemy, EnemyId, GameState, HunterChoice,
    Investigator, InvestigatorId, LocationId, Phase, SkillKind, SkillTestFollowUp,
    SpawnEngagePending, Status, WindowKind, Zone,
};
...
fn damage_enemy(
    ...
    if new_damage >= enemy.max_health {
        ...
        reaction_windows::queue_reaction_window(
            state,
            events,
