...
Rulings last updated on ArkhamDB 2020-03-17; fetched 2026-08-15. Source: <https://arkhamdb.com/card/01005>

- [reaction] If you use Wendy's ability to 'cancel a chaos token', treat it as if you've never revealed that token, for purposes of effects that trigger if a specific symbol is revealed (e.g. [Baseball Bat](https://arkhamdb.com/card/01074)).

- [elder_sign] If a skill test automatically succeeds, the total difficulty of that test is considered 0.
