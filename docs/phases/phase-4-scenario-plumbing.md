...
🟡 In progress. Design pass complete 2026-05-21. First five PRs merged: `#103` unified window stack as PR #129, `#74` ScenarioModule skeleton as PR #130, `#72` encounter deck state as PR #132, `#126` Revelation DSL + on-draw resolution as PR #133, and `#127` enemy spawn rules as PR #135. Remaining: `#69`, `#70`, `#71`, `#128`, `#73`.
