...
- **Engine north-star — trigger-dispatch rework (cross-slice; kickoff
  ...
  **✅ PR #369**: Before-timing dispatch through `emit_event` + an
  ...
  leave-trigger machinery (PR #372); **Mind over Matter (#322) is the last open
  Axis-E card** (stat-substitution + until-end-of-round modifier).
