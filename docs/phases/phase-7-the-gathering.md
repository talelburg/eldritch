...
`FastWindow` in the EmitEvent-frame slice
([#431](https://github.com/talelburg/eldritch/issues/431)). **#64 and #423
remain;** Fire Axe (02032) is the documented first real card consumer.
